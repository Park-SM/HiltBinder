...
internal class HiltMapBindsJavaModuleGenerator : JavaModuleGenerator<HiltMapBindsJavaParamsModel>() {
    ...
    override fun generate(env: ProcessingEnvironment, params: HiltMapBindsJavaParamsModel, logger: Logger) {
